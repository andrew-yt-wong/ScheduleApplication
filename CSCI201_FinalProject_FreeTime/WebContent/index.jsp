...
<head>
	...
	<%
		...
		if (request.getAttribute("confirmError") != null)
			confirmError = request.getAttribute("confirmError").toString();
		if (request.getAttribute("signinUserError") != null)
			signinUserError = request.getAttribute("signinUserError").toString();
		if (request.getAttribute("signinPassError") != null)
			signinPassError = request.getAttribute("signinPassError").toString();
		if (request.getAttribute("signinError") != null)
			signinError = request.getAttribute("signinError").toString();
	%>
</head>
